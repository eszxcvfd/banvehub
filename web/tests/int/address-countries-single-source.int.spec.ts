 ...
 *   2. the live `enum_addresses_country` equals the list as a set **and in order** — read from
 ...
 *   3. the sanitized `addresses` collection — the one the REST API and the admin actually use —
