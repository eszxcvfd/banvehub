...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  ALTER TABLE "software_types" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "software_types_texts" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "tags" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "product_previews" DISABLE ROW LEVEL SECURITY;
  DROP TABLE "software_types" CASCADE;
  DROP TABLE "software_types_texts" CASCADE;
  DROP TABLE "tags" CASCADE;
  DROP TABLE "product_previews" CASCADE;
  ...
  ALTER TABLE "products_rels" DROP CONSTRAINT "products_rels_product_previews_fk";
  
  ALTER TABLE "products_rels" DROP CONSTRAINT "products_rels_software_types_fk";
  
  ALTER TABLE "products_rels" DROP CONSTRAINT "products_rels_tags_fk";
  
  ALTER TABLE "_products_v_rels" DROP CONSTRAINT "_products_v_rels_product_previews_fk";
  
  ALTER TABLE "_products_v_rels" DROP CONSTRAINT "_products_v_rels_software_types_fk";
  
  ALTER TABLE "_products_v_rels" DROP CONSTRAINT "_products_v_rels_tags_fk";
  
  ALTER TABLE "payload_locked_documents_rels" DROP CONSTRAINT "payload_locked_documents_rels_software_types_fk";
  
  ALTER TABLE "payload_locked_documents_rels" DROP CONSTRAINT "payload_locked_documents_rels_tags_fk";
  
  ALTER TABLE "payload_locked_documents_rels" DROP CONSTRAINT "payload_locked_documents_rels_product_previews_fk";
  ...
  DROP INDEX "products_rels_product_previews_id_idx";
  DROP INDEX "products_rels_software_types_id_idx";
  DROP INDEX "products_rels_tags_id_idx";
  DROP INDEX "_products_v_rels_product_previews_id_idx";
  DROP INDEX "_products_v_rels_software_types_id_idx";
  DROP INDEX "_products_v_rels_tags_id_idx";
  DROP INDEX "payload_locked_documents_rels_software_types_id_idx";
  DROP INDEX "payload_locked_documents_rels_tags_id_idx";
  DROP INDEX "payload_locked_documents_rels_product_previews_id_idx";
  ALTER TABLE "products_gallery" ADD COLUMN "variant_option_id" integer;
  ...
  ALTER TABLE "_products_v_version_gallery" ADD COLUMN "variant_option_id" integer;
  ...
  ALTER TABLE "orders_items" ADD COLUMN "variant_id" integer;
  ALTER TABLE "transactions_items" ADD COLUMN "variant_id" integer;
  ALTER TABLE "transactions" ADD COLUMN "cart_id" integer;
  ...
  ALTER TABLE "products_gallery" DROP COLUMN "caption";
  ALTER TABLE "products" DROP COLUMN "price";
  ALTER TABLE "products" DROP COLUMN "is_free";
  ALTER TABLE "products" DROP COLUMN "technical_specs_file_format";
  ALTER TABLE "products" DROP COLUMN "technical_specs_software_version";
  ALTER TABLE "products" DROP COLUMN "technical_specs_file_size";
  ALTER TABLE "products" DROP COLUMN "technical_specs_unit";
  ALTER TABLE "products_rels" DROP COLUMN "product_previews_id";
  ALTER TABLE "products_rels" DROP COLUMN "software_types_id";
  ALTER TABLE "products_rels" DROP COLUMN "tags_id";
  ALTER TABLE "_products_v_version_gallery" DROP COLUMN "caption";
  ALTER TABLE "_products_v" DROP COLUMN "version_price";
  ALTER TABLE "_products_v" DROP COLUMN "version_is_free";
  ALTER TABLE "_products_v" DROP COLUMN "version_technical_specs_file_format";
  ALTER TABLE "_products_v" DROP COLUMN "version_technical_specs_software_version";
  ALTER TABLE "_products_v" DROP COLUMN "version_technical_specs_file_size";
  ALTER TABLE "_products_v" DROP COLUMN "version_technical_specs_unit";
  ALTER TABLE "_products_v_rels" DROP COLUMN "product_previews_id";
  ALTER TABLE "_products_v_rels" DROP COLUMN "software_types_id";
  ALTER TABLE "_products_v_rels" DROP COLUMN "tags_id";
  ALTER TABLE "payload_locked_documents_rels" DROP COLUMN "software_types_id";
  ALTER TABLE "payload_locked_documents_rels" DROP COLUMN "tags_id";
  ALTER TABLE "payload_locked_documents_rels" DROP COLUMN "product_previews_id";
  DROP TYPE "public"."enum_categories_status";
  DROP TYPE "public"."enum_product_previews_preview_type";
  DROP TYPE "public"."enum_products_technical_specs_unit";
  DROP TYPE "public"."enum__products_v_version_technical_specs_unit";`)
}
