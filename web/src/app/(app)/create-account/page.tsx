        ...
        <div className="bg-white rounded-3xl shadow-xl shadow-slate-900/5 border border-slate-200/80 overflow-hidden grid grid-cols-1 lg:grid-cols-12 items-stretch min-h-[660px]">
          ...
          <div className="w-full lg:col-span-7 p-6 sm:p-8 lg:p-10 xl:p-12 flex flex-col justify-between bg-white">
            <div>
              ...
              {/* Header / Title - Exact 'Create Account' text preserved for test invariants */}
              <div className="mb-6">
                ...
                <p className="mt-2 text-xs sm:text-sm text-slate-500 leading-relaxed">
                  Đăng ký tài khoản KienTaoHub để truy cập kho tài nguyên bản vẽ CAD, BIM và quản lý đơn hàng của bạn.
                </p>
              </div>
              ...
              {/* Interactive Create Account Form */}
...
export const metadata: Metadata = {
  description: 'Đăng ký tài khoản KienTaoHub để quản lý kho tài nguyên bản vẽ CAD, mô hình 3D và lịch sử đơn hàng.',
